...
export class PageFactory {
  ...
  async _generatePage(page, clusterMap, templateMap, linker) {
    try {
      ...
      // Check noindex threshold
      const wordCount = this._wordCount(slots.body_content || '');
  ...
  _wrapNextJs(slug, html) {
    ...
    // Slots are passed as a data object so your existing component can consume them
    // without dangerouslySetInnerHTML if you prefer a proper React implementation.
...
export default function Page() {
  ...
  // The <head> SEO tags are injected separately via Next.js Head component.
  return (
